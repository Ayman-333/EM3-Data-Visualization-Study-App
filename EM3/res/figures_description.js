module.exports = {
  descriptions: {
    ...
    spiral: 'Shows the total daily energy consumption (in kWh) for the whole year for a house. Tapping on a bar shows a tooltip with more information. To zoom in, double tap on the plot.',
