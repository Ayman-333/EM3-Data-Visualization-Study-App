module.exports = {
  descriptions: {
    ...
    stackedBar: 'Shows power ratings (in W) for each appliance (and their different brands) throughout the day. An appliance can be chosen from the scrollable list',
